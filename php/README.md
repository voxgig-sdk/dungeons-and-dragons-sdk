...
The PHP SDK for the DungeonsAndDragons API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->GetApiRoot(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->DungeonsAndDragons(null)->load(
    ["id" => "test01"], null
);
