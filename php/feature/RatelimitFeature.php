...
// DungeonsAndDragons SDK ratelimit feature
...
class DungeonsAndDragonsRatelimitFeature extends DungeonsAndDragonsBaseFeature
{
    ...
    private function _acquire(DungeonsAndDragonsContext $ctx): void
    {
    ...
    private function _track(DungeonsAndDragonsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
