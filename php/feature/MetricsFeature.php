...
// DungeonsAndDragons SDK metrics feature
...
class DungeonsAndDragonsMetricsFeature extends DungeonsAndDragonsBaseFeature
{
    ...
    private function _record(DungeonsAndDragonsContext $ctx, bool $ok): void
    {
