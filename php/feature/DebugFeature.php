...
// DungeonsAndDragons SDK debug feature
...
class DungeonsAndDragonsDebugFeature extends DungeonsAndDragonsBaseFeature
{
    ...
    private function _finish(DungeonsAndDragonsContext $ctx, bool $ok): void
    {
