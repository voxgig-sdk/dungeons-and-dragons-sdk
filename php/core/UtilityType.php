...
// DungeonsAndDragons SDK utility type

class DungeonsAndDragonsUtility
{
    ...
    public static function copy(DungeonsAndDragonsUtility $src): DungeonsAndDragonsUtility
    {
        $u = new DungeonsAndDragonsUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
