...
class GetApiRootDirectTest extends TestCase
{
    public function test_direct_load_get_api_root(): void
    {
        $setup = get_api_root_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-get_api_root", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
