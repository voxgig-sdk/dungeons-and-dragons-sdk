...
class GetResourceByIndexDirectTest extends TestCase
{
    public function test_direct_load_get_resource_by_index(): void
    {
        $setup = get_resource_by_index_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-get_resource_by_index", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
