...
// DungeonsAndDragons SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DungeonsAndDragonsSDK::test)
...
{
    private const SDK_CLASS = 'DungeonsAndDragonsSDK';
    ...
    private const SDK_BASE = 'dungeonsanddragons_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../dungeonsanddragons_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
