// Command DungeonsAndDragons-mcp is an MCP server exposing the DungeonsAndDragons
// SDK as MCP tools.
//
// Two tools are registered:
//
//	DungeonsAndDragons_list  — list records of an entity
//	DungeonsAndDragons_load  — load a single record of an entity
//
