...
function runner.env_override(m)
  local live = runner.getenv("DUNGEONSANDDRAGONS_TEST_LIVE")
  local override = runner.getenv("DUNGEONSANDDRAGONS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("DUNGEONSANDDRAGONS_TEST_EXPLAIN")
