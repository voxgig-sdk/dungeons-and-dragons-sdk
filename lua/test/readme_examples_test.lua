...
local SDK_MODULE = "dungeons-and-dragons_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["get_api_root"] = { ["test01"] = { id = "test01" } }, ["get_resource_by_index"] = { ["test01"] = { id = "test01" } }, ["get_resource_list"] = { ["test01"] = { id = "test01" } }, ["graph_ql"] = { ["test01"] = { id = "test01" } } } }'
