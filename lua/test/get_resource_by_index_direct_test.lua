...
describe("GetResourceByIndexDirect", function()
  it("should direct-load-get_resource_by_index", function()
    local setup = get_resource_by_index_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_resource_by_index", setup.live and "live" or "unit")
...
function get_resource_by_index_direct_setup(mockres)
