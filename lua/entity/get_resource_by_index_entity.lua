...
local GetResourceByIndexEntity = {}
GetResourceByIndexEntity.__index = GetResourceByIndexEntity


function GetResourceByIndexEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetResourceByIndexEntity)
  self._name = "get_resource_by_index"
  self._client = client
...
function GetResourceByIndexEntity:get_name()
  return self._name
end


function GetResourceByIndexEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetResourceByIndexEntity.new(self._client, opts)
end
...
function GetResourceByIndexEntity:mark_deleted()
  self._deleted = true
end


function GetResourceByIndexEntity:deleted()
  return true == self._deleted
end


function GetResourceByIndexEntity:data_set(args)
  if args ~= nil then
...
function GetResourceByIndexEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetResourceByIndexEntity:match_set(args)
  if args ~= nil then
...
function GetResourceByIndexEntity:match_get()
...
function GetResourceByIndexEntity:stream(action, args, callopts)
...
---@param reqmatch GetResourceByIndexLoadMatch
---@param ctrl? table
---@return GetResourceByIndex
---@return string? err
function GetResourceByIndexEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GetResourceByIndexEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GetResourceByIndexEntity
