...
local GetResourceListEntity = {}
GetResourceListEntity.__index = GetResourceListEntity


function GetResourceListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetResourceListEntity)
  self._name = "get_resource_list"
  self._client = client
...
function GetResourceListEntity:get_name()
  return self._name
end


function GetResourceListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetResourceListEntity.new(self._client, opts)
end
...
function GetResourceListEntity:mark_deleted()
  self._deleted = true
end


function GetResourceListEntity:deleted()
  return true == self._deleted
end


function GetResourceListEntity:data_set(args)
  if args ~= nil then
...
function GetResourceListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetResourceListEntity:match_set(args)
  if args ~= nil then
...
function GetResourceListEntity:match_get()
...
function GetResourceListEntity:stream(action, args, callopts)
...
---@param reqmatch GetResourceListListMatch
---@param ctrl? table
---@return GetResourceList[]
---@return string? err
function GetResourceListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function GetResourceListEntity:_run_op(ctx, post_done)
  local utility = self._utility
