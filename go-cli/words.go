...
func registerSDKWords(r *eng.Registry, client *sdk.DungeonsAndDragonsSDK) {
...
func runOp(client *sdk.DungeonsAndDragonsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
