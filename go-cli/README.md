...
AQL-driven CLI and REPL for the DungeonsAndDragons SDK. Positional arguments are
...
```sh
go build -o dungeons-and-dragons-cli ./...
```
...
./dungeons-and-dragons-cli list get_api_root
./dungeons-and-dragons-cli load 1 get_api_root
./dungeons-and-dragons-cli load '{id:1}' get_api_root
