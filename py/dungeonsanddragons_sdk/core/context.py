...
from dungeonsanddragons_sdk.core.control import DungeonsAndDragonsControl
...
from dungeonsanddragons_sdk.core.helpers import get_ctx_prop, to_map
...
class DungeonsAndDragonsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = DungeonsAndDragonsControl()
        ...
        if isinstance(sp, DungeonsAndDragonsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, DungeonsAndDragonsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, DungeonsAndDragonsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return DungeonsAndDragonsOperation({})
        ...
        op = DungeonsAndDragonsOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return DungeonsAndDragonsError(code, msg, self)
