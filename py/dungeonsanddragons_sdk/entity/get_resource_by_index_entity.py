...
from dungeonsanddragons_sdk.dungeonsanddragons_types import (
    GetResourceByIndex,
...
class GetResourceByIndexEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetResourceByIndexEntity(self._client, opts)
    ...
    def data_get(self) -> GetResourceByIndex:
    ...
    def match_get(self) -> GetResourceByIndex:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetResourceByIndex:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetResourceByIndex().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
