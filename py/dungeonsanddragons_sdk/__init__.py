...
from dungeonsanddragons_sdk.utility import register

# Load features
from dungeonsanddragons_sdk.feature.base_feature import DungeonsAndDragonsBaseFeature
from dungeonsanddragons_sdk.features import _has_feature, _make_feature
...
class DungeonsAndDragonsSDK:
    ...
    def get_utility(self):
        return DungeonsAndDragonsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("DungeonsAndDragonsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetApiRoot(self, data=None) -> "GetApiRootEntity":
        ...
        from dungeonsanddragons_sdk.entity.get_api_root_entity import GetApiRootEntity
    ...
    def GetResourceByIndex(self, data=None) -> "GetResourceByIndexEntity":
        ...
        from dungeonsanddragons_sdk.entity.get_resource_by_index_entity import GetResourceByIndexEntity
    ...
    def GetResourceList(self, data=None) -> "GetResourceListEntity":
        ...
        from dungeonsanddragons_sdk.entity.get_resource_list_entity import GetResourceListEntity
    ...
    def GraphQl(self, data=None) -> "GraphQlEntity":
        ...
        from dungeonsanddragons_sdk.entity.graph_ql_entity import GraphQlEntity
