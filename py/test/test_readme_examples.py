# DungeonsAndDragons SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DungeonsAndDragonsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DungeonsAndDragonsSDK(...) and DungeonsAndDragonsSDK.test(...) become
#      DungeonsAndDragonsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "dungeonsanddragons_sdk"
_SDK_CLASS = "DungeonsAndDragonsSDK"
...
_ENTITIES = {
    "GetApiRoot": "get_api_root",
    "GetResourceByIndex": "get_resource_by_index",
