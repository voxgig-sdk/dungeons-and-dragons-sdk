...
The SDK exposes the API as capitalised, semantic **Entities** — for example `client.GetApiRoot()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/dungeons-and-dragons-sdk/releases)) or
...
| --- | --- | --- |
| `id` | `str` |  |
| `index` | `str` | Resource index for URL purposes |
...
| `operationName` | `str` | Optional operation name if multiple operations in query |
...
```
py/
├── dungeonsanddragons_sdk.py         -- Main SDK module
