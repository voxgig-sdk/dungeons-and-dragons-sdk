...
type GetResourceByIndexEntity struct {
	name    string
	client  *core.DungeonsAndDragonsSDK
...
func NewGetResourceByIndexEntity(client *core.DungeonsAndDragonsSDK, entopts map[string]any) *GetResourceByIndexEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetResourceByIndexEntity) GetName() string { return e.name }
...
func (e *GetResourceByIndexEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetResourceByIndexEntity) Deleted() bool {
	return e.deleted
}


func (e *GetResourceByIndexEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetResourceByIndexEntity(e.client, opts)
}

func (e *GetResourceByIndexEntity) Data(args ...any) any {
...
func (e *GetResourceByIndexEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetResourceByIndex; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetResourceByIndexEntity) DataTyped(data ...GetResourceByIndex) GetResourceByIndex {
	if len(data) > 0 {
		return typedFrom[GetResourceByIndex](e.Data(asMap(data[0])))
	}
	return typedFrom[GetResourceByIndex](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetResourceByIndex (all fields
// optional at the wire level).
func (e *GetResourceByIndexEntity) MatchTyped(match ...GetResourceByIndex) GetResourceByIndex {
	if len(match) > 0 {
		return typedFrom[GetResourceByIndex](e.Match(asMap(match[0])))
	}
	return typedFrom[GetResourceByIndex](e.Match())
}
...
func (e *GetResourceByIndexEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetResourceByIndexEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetResourceByIndexLoadMatch and returns an GetResourceByIndex. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GetResourceByIndexEntity) LoadTyped(reqmatch GetResourceByIndexLoadMatch, ctrl map[string]any) (GetResourceByIndex, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GetResourceByIndex{}, err
	}
	return typedFrom[GetResourceByIndex](res), nil
}



func (e *GetResourceByIndexEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetResourceByIndexEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetResourceByIndexEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetResourceByIndexEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetResourceByIndexEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
