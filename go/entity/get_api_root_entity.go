...
func NewGetApiRootEntity(client *core.DungeonsAndDragonsSDK, entopts map[string]any) *GetApiRootEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetApiRootEntity) GetName() string { return e.name }
...
func (e *GetApiRootEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetApiRootEntity) Deleted() bool {
	return e.deleted
}


func (e *GetApiRootEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetApiRootEntity(e.client, opts)
}

func (e *GetApiRootEntity) Data(args ...any) any {
...
func (e *GetApiRootEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetApiRoot; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetApiRootEntity) DataTyped(data ...GetApiRoot) GetApiRoot {
	if len(data) > 0 {
		return typedFrom[GetApiRoot](e.Data(asMap(data[0])))
	}
	return typedFrom[GetApiRoot](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetApiRoot (all fields
// optional at the wire level).
func (e *GetApiRootEntity) MatchTyped(match ...GetApiRoot) GetApiRoot {
	if len(match) > 0 {
		return typedFrom[GetApiRoot](e.Match(asMap(match[0])))
	}
	return typedFrom[GetApiRoot](e.Match())
}
...
func (e *GetApiRootEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetApiRootEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetApiRootLoadMatch and returns an GetApiRoot. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GetApiRootEntity) LoadTyped(reqmatch GetApiRootLoadMatch, ctrl map[string]any) (GetApiRoot, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GetApiRoot{}, err
	}
	return typedFrom[GetApiRoot](res), nil
}



func (e *GetApiRootEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetApiRootEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetApiRootEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetApiRootEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetApiRootEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
