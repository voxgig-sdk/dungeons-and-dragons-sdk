...
type GetResourceListEntity struct {
	name    string
...
func NewGetResourceListEntity(client *core.DungeonsAndDragonsSDK, entopts map[string]any) *GetResourceListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetResourceListEntity) GetName() string { return e.name }
...
func (e *GetResourceListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetResourceListEntity) Deleted() bool {
	return e.deleted
}


func (e *GetResourceListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetResourceListEntity(e.client, opts)
}

func (e *GetResourceListEntity) Data(args ...any) any {
...
func (e *GetResourceListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *GetResourceListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetResourceListEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *GetResourceListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetResourceListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetResourceListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetResourceListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
