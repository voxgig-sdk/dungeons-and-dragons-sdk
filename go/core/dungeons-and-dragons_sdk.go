...
type DungeonsAndDragonsSDK struct {
	Mode     string
...
func (sdk *DungeonsAndDragonsSDK) OptionsMap() map[string]any {
...
func (sdk *DungeonsAndDragonsSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *DungeonsAndDragonsSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *DungeonsAndDragonsSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DungeonsAndDragonsSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *DungeonsAndDragonsSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *DungeonsAndDragonsSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("DungeonsAndDragonsSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *DungeonsAndDragonsSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DungeonsAndDragonsSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("DungeonsAndDragonsSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *DungeonsAndDragonsSDK {
	...
	sdk := NewDungeonsAndDragonsSDK(sdkopts)
	sdk.Mode = "test"
