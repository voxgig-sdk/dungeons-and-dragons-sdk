...
// instead of `sdk.NewDungeonsAndDragonsSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *DungeonsAndDragonsSDK  { return NewDungeonsAndDragonsSDK(nil) }
func Test() *DungeonsAndDragonsSDK { return TestSDK(nil, nil) }
