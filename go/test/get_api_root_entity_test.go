...
func TestGetApiRootEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		getApiRootRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.get_api_root")))
...
func get_api_rootBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("DUNGEONS_AND_DRAGONS_TEST_GET_API_ROOT_ENTID")
	...
	idmapResolved := core.ToMapAny(env["DUNGEONS_AND_DRAGONS_TEST_GET_API_ROOT_ENTID"])
