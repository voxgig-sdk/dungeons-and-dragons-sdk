...
func get_resource_by_indexBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("DUNGEONS_AND_DRAGONS_TEST_GET_RESOURCE_BY_INDEX_ENTID")
	...
	idmapResolved := core.ToMapAny(env["DUNGEONS_AND_DRAGONS_TEST_GET_RESOURCE_BY_INDEX_ENTID"])
