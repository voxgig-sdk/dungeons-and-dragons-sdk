...
const testSeed = `map[string]any{"entity": map[string]any{"get_api_root": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_resource_by_index": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_resource_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "graph_ql": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
