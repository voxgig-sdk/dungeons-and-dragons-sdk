...
The Golang SDK for the DungeonsAndDragons API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/dungeons-and-dragons-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/dungeons-and-dragons-sdk=../path/to/github.com/voxgig-sdk/dungeons-and-dragons-sdk
```
...
```
github.com/voxgig-sdk/dungeons-and-dragons-sdk/
...
The root package (`github.com/voxgig-sdk/dungeons-and-dragons-sdk`) re-exports everything needed
