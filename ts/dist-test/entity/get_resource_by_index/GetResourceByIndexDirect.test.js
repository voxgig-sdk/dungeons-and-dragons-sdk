...
(0, node_test_1.describe)('GetResourceByIndexDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-get_resource_by_index', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_resource_by_index', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["index01", "resource01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DUNGEONS_AND_DRAGONS_TEST_GET_RESOURCE_BY_INDEX_ENTID'];
...
//# sourceMappingURL=GetResourceByIndexDirect.test.js.map