...
(0, node_test_1.describe)('GetApiRootDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-get_api_root', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_api_root', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DUNGEONS_AND_DRAGONS_TEST_GET_API_ROOT_ENTID'];
...
//# sourceMappingURL=GetApiRootDirect.test.js.map