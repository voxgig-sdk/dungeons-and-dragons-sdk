...
(0, node_test_1.describe)('GetResourceListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.DungeonsAndDragonsSDK({
    ...
    (0, node_test_1.test)('direct-list-get_resource_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-get_resource_list', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["get_resource_list01"]))
            return;
...
function liveScenariosActive() { return false && process.env.DUNGEONS_AND_DRAGONS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.DungeonsAndDragonsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['DUNGEONS_AND_DRAGONS_TEST_GET_RESOURCE_LIST_ENTID'];
    ...
    const client = new __1.DungeonsAndDragonsSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetResourceListDirect.test.js.map