# DungeonsAndDragons TypeScript SDK



The TypeScript SDK for the DungeonsAndDragons API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.GetApiRoot()` — each with a small set of operations (`list`, `load`, `create`)
...
| `tester(testopts?, sdkopts?)` | `DungeonsAndDragonsSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `DungeonsAndDragonsSDK.test(testopts?, sdkopts?)` | `DungeonsAndDragonsSDK` | Create a test-mode client. |
...
├── src/
│   ├── DungeonsAndDragonsSDK.ts        # Main SDK class
