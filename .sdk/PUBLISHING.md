...
|---|---|---|
| `ts/` | @voxgig-sdk/dungeons-and-dragons-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/dungeons-and-dragons-sdk \
      --repository voxgig-sdk/dungeons-and-dragons-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/dungeons-and-dragons-sdk` shows it, and
`npm trust revoke @voxgig-sdk/dungeons-and-dragons-sdk --id=<id>` removes it.
