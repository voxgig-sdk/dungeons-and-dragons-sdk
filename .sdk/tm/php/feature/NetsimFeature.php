...
// DungeonsAndDragons SDK netsim feature
...
class DungeonsAndDragonsNetsimFeature extends DungeonsAndDragonsBaseFeature
{
    ...
    private function _simulate(DungeonsAndDragonsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(DungeonsAndDragonsContext $ctx, array $applied): void
    {
        $client = $this->client;
