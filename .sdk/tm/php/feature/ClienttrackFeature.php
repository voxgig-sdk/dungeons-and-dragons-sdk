...
// DungeonsAndDragons SDK clienttrack feature
...
class DungeonsAndDragonsClienttrackFeature extends DungeonsAndDragonsBaseFeature
{
    ...
    public function PostConstruct(DungeonsAndDragonsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'DungeonsAndDragons-SDK';
