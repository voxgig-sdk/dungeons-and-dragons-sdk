...
// DungeonsAndDragons SDK audit feature
...
class DungeonsAndDragonsAuditFeature extends DungeonsAndDragonsBaseFeature
{
    ...
    private function _emit(DungeonsAndDragonsContext $ctx, string $outcome): void
    {
