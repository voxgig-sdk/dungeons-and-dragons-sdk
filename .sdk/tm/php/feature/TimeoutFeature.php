...
// DungeonsAndDragons SDK timeout feature
...
class DungeonsAndDragonsTimeoutFeature extends DungeonsAndDragonsBaseFeature
{
    ...
    private function _with_timeout(DungeonsAndDragonsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DungeonsAndDragonsContext $_ctx, float $ms): void
    {
        $client = $this->client;
