...
// DungeonsAndDragons SDK proxy feature
...
class DungeonsAndDragonsProxyFeature extends DungeonsAndDragonsBaseFeature
{
    ...
    public function init(DungeonsAndDragonsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DungeonsAndDragonsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
