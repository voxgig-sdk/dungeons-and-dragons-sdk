...
// DungeonsAndDragons SDK rbac feature
...
class DungeonsAndDragonsRbacFeature extends DungeonsAndDragonsBaseFeature
{
    ...
    private function _required(DungeonsAndDragonsContext $ctx): ?string
    {
    ...
    private function _reject(DungeonsAndDragonsContext $ctx, string $required): void
    {
    ...
    private function _track(DungeonsAndDragonsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
