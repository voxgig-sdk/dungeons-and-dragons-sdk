...
// DungeonsAndDragons SDK utility: fetcher

class DungeonsAndDragonsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DungeonsAndDragonsSDK/1.0)';
    ...
    public static function call(DungeonsAndDragonsContext $ctx, string $fullurl, array $fetchdef): array
    {
