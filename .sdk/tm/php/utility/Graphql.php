...
// DungeonsAndDragons SDK utility: graphql
//
...
class DungeonsAndDragonsGraphql
{
    ...
    // equivalent.
    public static function body(DungeonsAndDragonsContext $ctx): mixed
    {
    ...
    public static function errors(DungeonsAndDragonsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
