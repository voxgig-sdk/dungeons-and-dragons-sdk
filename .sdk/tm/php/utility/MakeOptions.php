...
// DungeonsAndDragons SDK utility: make_options

class DungeonsAndDragonsMakeOptions
{
    ...
    public static function call(DungeonsAndDragonsContext $ctx): array
    {
        ...
        //
        // `DungeonsAndDragonsSchema::optspec()` is built from the model:
        ...
        $optspec = DungeonsAndDragonsSchema::optspec();
