...
// DungeonsAndDragons SDK utility: result_basic

class DungeonsAndDragonsResultBasic
{
    public static function call(DungeonsAndDragonsContext $ctx): ?DungeonsAndDragonsResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof DungeonsAndDragonsError) ? $result->err->msg : (string)$result->err;
