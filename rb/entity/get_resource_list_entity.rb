...
class GetResourceListEntity
  ...
  def make
    opts = @_entopts.dup
    GetResourceListEntity.new(@_client, opts)
  end
  ...
  # @return [GetResourceList, Hash] the current GetResourceList data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GetResourceList fields)
  def match_get
  ...
  #
  # @param reqmatch [GetResourceListListMatch, Hash, nil] match filter (any subset of
  #   GetResourceList fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<GetResourceList>, Array] the matching GetResourceList items; raises DungeonsAndDragonsError on failure
