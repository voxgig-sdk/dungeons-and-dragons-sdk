...
class GetApiRootEntity
  ...
  def make
    opts = @_entopts.dup
    GetApiRootEntity.new(@_client, opts)
  end
  ...
  #   as an empty match, so client.GetApiRoot.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [GetApiRoot, Hash] the loaded GetApiRoot; raises DungeonsAndDragonsError on failure
