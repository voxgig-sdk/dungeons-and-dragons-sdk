...
#      offline in seeded test mode (DungeonsAndDragonsSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "DungeonsAndDragons_sdk.rb")
  SDK_CLASS = "DungeonsAndDragonsSDK"
  ...
  SDK_BASE = "DungeonsAndDragons_sdk"
